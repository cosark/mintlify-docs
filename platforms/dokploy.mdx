...
<Frame>
  ![Dokploy Platform](/images/dokploy-platform.png)
</Frame>
...
<Steps>
  ...
  <Step title="Select Resources">
    Choose resources for your Dokploy instance (we recommend at least 2GB RAM / 1 vCPU)
  </Step>
...
<Note>
  Dokploy requires more resources than standard applications due to its platform nature. As your container count grows, you may need to scale up your Dokploy instance.
</Note>
...
- **Dokploy Documentation**: Available through the Dokploy dashboard
