...
- **Fixed Tier Approach**: Would require provisioning for peak traffic (4GB RAM, 2vCPU) at &dollar;12/month
- **With Autoscaling**: Average resource usage might be only 1.5GB RAM and 0.8vCPU across 24 hours
- **Resulting Billing**: Approximately &dollar;4.50/month (62.5% savings)

### Example 2: Business Application with Weekend Drop-offs

An internal business application used primarily Monday to Friday:

- **Fixed Tier Approach**: Requires 8GB RAM, 4vCPU at &dollar;24/month
- **With Autoscaling**: Resources scale down by 80% during weekends (28.6% of the month)
- **Resulting Billing**: Approximately &dollar;18.85/month (21.5% savings)

### Example 3: E-commerce with Seasonal Peaks

An e-commerce store with significant traffic during holiday seasons:

- **Fixed Tier Approach**: Would need to provision for peak season (16GB RAM, 8vCPU) at &dollar;48/month year-round
- **With Autoscaling**: Resources might average 4GB RAM, 2vCPU during regular periods
- **Resulting Billing**: Averaged across the year, approximately &dollar;18/month (62.5% savings)
...
5. **Minimum Charge**: A minimum of &dollar;3.00 per month applies to all applications
...
- **Minimum Charge**: All applications have a minimum charge of &dollar;3.00 per month
