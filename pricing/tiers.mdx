...
<Frame>
  ![Resource Tiers](/images/resource-tiers.png)
</Frame>
...
<CardGroup>
  ...
  <Card title="Additional Resources" icon="server" href="/pricing/additional-resources">
    Explore additional resource options beyond the standard tiers
  </Card>
</CardGroup> 