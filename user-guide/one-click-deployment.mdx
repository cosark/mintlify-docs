...
<Steps>
  <Step title="Browse the Marketplace">
    Explore our [marketplace](https://repocloud.io/results) or view our [catalog of supported applications](/platform/supported-apps) to find the one you want to deploy.
  </Step>
...
<Steps>
  ...
  <Step title="Deploy">
    Click "Deploy" and wait for the deployment to complete (typically 3-7 minutes).
  </Step>
