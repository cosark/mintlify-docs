...
<Steps>
  ...
  <Step title="Access and Configure">
    Once deployment is complete, you will receive a URL to access your application. Most applications will have a setup wizard or admin interface for further configuration.
  </Step>
</Steps>
...
RepoCloud offers multiple deployment regions to help you serve your users with lower latency. When deploying an application, you can choose the region closest to your target audience:
...
<Tip>
  Choosing a region closer to your users will reduce latency and improve the user experience.
</Tip>
...
<AccordionGroup>
  <Accordion title="How long does deployment take?">
    Most applications deploy within 1-2 minutes. Larger applications with more complex setups might take up to 5 minutes.
  </Accordion>
